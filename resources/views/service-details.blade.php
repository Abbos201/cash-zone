...
<body>
  ...
  <div class="lightdark-switch">
    <span class="switch-btn" id="btnSwitch"><img src="assets/images/icon/moon.svg" alt="light-dark-switchbtn" class="swtich-icon"></span>
  </div>
  <!-- ===============>> light&dark switch start here <<================= -->
                          ...
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                ...
                                <a href="index-1.html?theme=light" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"><a href="index-1.html?theme=light">Stock Trading</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                          <div class="home-showcase__item">
                            ...
                            <h3 class="home-showcase__title"><a href="index-2.html?theme=dark">Stock Trading Dark</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-2-1.html?theme=light" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"> <a href="index-2-1.html?theme=light">Crypto Trading</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-2-2.html?theme=dark" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"> <a href="index-2-2.html?theme=dark">Crypto Trading Dark</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-3-1.html?theme=dark" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"><a href="index-3-1.html?theme=dark">Forex Trading Dark</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-4-1.html?theme=dark" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"><a href="index-4-1.html?theme=dark">Day Trading Dark</a>
                            </h3>
                          </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-5-1.html?theme=dark" class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                            <h3 class="home-showcase__title"><a href="index-5-1.html?theme=dark">Trading Platform Dark</a>
                            </h3>
                          </div>
                        </div>
                          ...
                          <div class="col-12">
                            <div class="accordion__item accordion-item">
                              <div class="accordion__header accordion-header" id="faq1">
                                <button class="accordion__button accordion-button accordion__button--style2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqBody1" aria-expanded="false" aria-controls="faqBody1">
                          ...
                          <div class="col-12">
                            <div class="accordion__item accordion-item">
                              <div class="accordion__header accordion-header" id="faq2">
                                <button class="accordion__button accordion-button accordion__button--style2 " type="button" data-bs-toggle="collapse" data-bs-target="#faqBody2" aria-expanded="true" aria-controls="faqBody2">
                          ...
                          <div class="col-12">
                            <div class="accordion__item accordion-item">
                              <div class="accordion__header accordion-header" id="faq3">
                                <button class="accordion__button accordion-button accordion__button--style2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqBody3" aria-expanded="false" aria-controls="faqBody3">
                          ...
                          <div class="col-12">
                            <div class="accordion__item accordion-item border-0">
                              <div class="accordion__header accordion-header" id="faq4">
                                <button class="accordion__button accordion-button accordion__button--style2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqBody4" aria-expanded="false" aria-controls="faqBody4">
  ...
  <footer class="footer ">
          ...
          <div class="row gy-5 gx-4">
            <div class="col-md-6">
              <div class="footer__about">
                <a href="index.html" class="footer__about-logo"><img src="assets/images/logo/logo-dark.png" alt="Logo"></a>
    ...
    <div class="footer__shape">
      <span class="footer__shape-item footer__shape-item--1"><img src="assets/images/footer/1.png" alt="shape icon"></span>
