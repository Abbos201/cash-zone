...
<body class="home-4">
  ...
  <section class="banner banner--style4 bg--cover" style="background-image:url(assets/images/banner/home4/1.png)">
          ...
          <div class="col-md-10 justify-content-center">
            <div class="banner__content" data-aos="fade-up" data-aos-duration="800">
              ...
              <div class="banner__content-btn btn-group justify-content-center">
                ...
                <a href="https://www.youtube.com/watch?v=MHhIzIgFgJo&ab_channel=NoCopyrightFootages" class="playbtn" data-fslightbox="">
    ...
    <div class="banner__shape">
      ...
      <span class="banner__shape-item banner__shape-item--5"><img src="assets/images/banner/home4/2.png" alt="shape icon"></span>
    </div>
  ...
  <section class="service padding-top padding-bottom bg-color-7">
    ...
    <div class="service__shape">
      ...
      <span class="service__shape-item service__shape-item--3"> <img src="assets/images/icon/shape/2.png" alt="shape-icon">
      </span>
    </div>
  ...
  <section class="pricing padding-top padding-bottom bg--cover" style="background-image:url(assets/images/pricing/bg.png)">
    <div class="section-header section-header--max50">
    ...
    <div class="pricing__shape">
      <span class="pricing__shape-item pricing__shape-item--5"> <img src="assets/images/icon/shape/3.png" alt="shape-icon"></span>
      <span class="pricing__shape-item pricing__shape-item--6"> <img src="assets/images/icon/shape/1.png" alt="shape-icon">
      </span>
    </div>
  </section>
  <!-- ===============>> Pricing section start here <<================= -->
      ...
      <div class="team__wrapper">
        <div class="row g-4 align-items-center">
              ...
              <div class="team__item team__item--shape" data-aos="fade-up" data-aos-duration="800">
                  <div class="team__item-inner team__item-inner--shape">
                      <div class="team__item-thumb team__item-thumb--style1">
                          <img src"" alt="Team Image" class="dark">
                      </div>
                      <div class="team__item-content team__item-content--style1">
                          <div class="team__item-author team__item-author--style1">
                              <div class="team__item-authorinfo">
                                  <h6 class="mb-1"><a href="team-details.html" class="stretched-link"></a></h6>
                                  <p class="mb-0"></p>
                              </div>
                          </div>
                      </div>
          ...
          <div class="text-center">
            <a href="/team" class="trk-btn trk-btn--border trk-btn--primary mt-25">View more </a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="blog padding-top padding-bottom">
    <div class="container">
      ...
      <div class="text-center">
        <a href="/robots" class="trk-btn trk-btn--border trk-btn--primary mt-15">View more </a>
      </div>
    </div>
