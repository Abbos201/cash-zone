...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="admin/app-assets/images/pages/register-v2.svg" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Register-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2">Quyidagi formani to'ldiring!</p>
                                <form class="auth-register-form mt-2" action="{{ route('register')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-label" for="register-username">Ism</label>
                                        <input class="form-control" id="register-username" type="text" value="{{ old('name') }}" name="name" placeholder="Dilnoza" aria-describedby="register-username" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="register-email">Email</label>
                                        <input class="form-control" id="register-email" type="text" name="email" value="{{ old('email') }}" placeholder="admin@admin.com" aria-describedby="register-email" tabindex="2" />
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="register-password">Parol</label>
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="register-password">Takroriy parol</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block" tabindex="5">Ro'yhatdan o'tish</button>
                                </form>
                                <p class="text-center mt-2"><span>Profilingiz bormi?</span><a href="{{route('login')}}"><span>&nbsp; Kirish </span></a></p>
    ...
    <!-- BEGIN: Page JS-->
    <script src="admin/app-assets/js/scripts/pages/page-auth-register.min.js"></script>
    <!-- END: Page JS-->
